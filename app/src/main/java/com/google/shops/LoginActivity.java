                ...
                if (dataSnapshot.child(parentDbName).child(phone).exists()){
                    ...
                    if (usersData.getPhone().equals(phone))
                    {
                        if (usersData.getPassword().equals(password))
                        {
                            ...
                            {
                                Toast.makeText(LoginActivity.this, "Добро пожаловать, дорогой админ.", Toast.LENGTH_SHORT).show();
                                loadingBar.dismiss();
                    ...
                    Toast.makeText(LoginActivity.this, "Аккаунт" + phone + " не найден.", Toast.LENGTH_SHORT).show();
                    loadingBar.dismiss();
                }
            }
